...
final class LongTestViewModel: IGDTestViewModelProtocol {
    ...
    private let questions = TestQuestions.allCases
    ...
    private func calculateResult() {
        ...
        switch totalScore {
        case 0...10: conclusion = "Низкий уровень зависимости. У вас сбалансированное отношение к играм."
        case 11...20: conclusion = "Средний уровень зависимости. Рекомендуется пересмотреть своё отношение к играм."
